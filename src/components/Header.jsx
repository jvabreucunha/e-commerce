...
export default function Header() {
  return (
    <header className="w-full bg-neutral-950 border-b border-neutral-800 shadow-md">
      <div className="w-full py-4 flex items-center justify-around">
        ...
        <div className="hidden md:flex items-center bg-neutral-900 border border-neutral-800 rounded-xl px-4 py-2 w-1/3">
